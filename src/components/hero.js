    ...
    <div className="container">
      <div className="row align-items-center">
        <div className="col-md-10">
          ...
          <h1 className="d-block mb-4" data-aos-disabled="fade-up" data-aos-delay="200">TSconf 2020</h1>
          <span className="d-block mb-5 caption" data-aos-disabled="fade-up" data-aos-delay="300">October 2nd, Desenzano del Garda, Italy</span>
